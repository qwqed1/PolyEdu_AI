          ...
          {user && (
            <nav className="hidden lg:flex items-center gap-5">
              ...
              {user.role === 'teacher' ? (
                ...
                <>
                  <Link to="/materials" className="text-neutral-700 dark:text-neutral-300 hover:text-primary-600 dark:hover:text-primary-400 transition-default font-medium flex items-center gap-1.5">
                    <BookOpen className="w-4 h-4" />
                    {t.nav.materials}
                  </Link>
              ...
              <Link to="/schedule" className="text-neutral-700 dark:text-neutral-300 hover:text-primary-600 dark:hover:text-primary-400 transition-default font-medium flex items-center gap-1.5">
          ...
          <div className="lg:hidden py-4 border-t border-neutral-200 dark:border-dark-border">
            {user ? (
              <div className="flex flex-col gap-3">
                ...
                <Link to="/schedule" className="px-3 py-2 text-neutral-700 dark:text-neutral-300 hover:bg-neutral-100 dark:hover:bg-neutral-800 rounded-lg transition-default flex items-center gap-2">
                  <Calendar className="w-4 h-4" />
                  {t.nav.schedule}
                </Link>
