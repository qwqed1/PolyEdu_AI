      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-xl font-bold">Uchi-IT</span>
            </div>
            <p className="text-gray-400 leading-relaxed">
              Онлайн-школа программирования для детей от 5 до 18 лет. 
              Учим создавать игры, сайты и приложения.
            </p>
          </div>
          
          {/* Navigation */}
          <div>
            <h3 className="font-bold mb-4 text-lg">Обучение</h3>
            <ul className="space-y-3">
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Scratch</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Roblox Studio</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Python</a></li>
        ...
        <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-gray-400 text-sm">
            © 2025 Uchi-IT. Все права защищены.
          </p>
          <div className="flex gap-6 text-sm">
            <a href="#" className="text-gray-400 hover:text-white transition-colors">Политика конфиденциальности</a>
            <a href="#" className="text-gray-400 hover:text-white transition-colors">Пользовательское соглашение</a>
          </div>
        </div>
      </div>
    </footer>
